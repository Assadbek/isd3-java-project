package com.example.findtutor.security;

import com.example.findtutor.Filter.MyAuthenticationFilter;
import com.example.findtutor.Filter.MyAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(GET,"/api/users/**", "/tutors/**").
